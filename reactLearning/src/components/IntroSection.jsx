        ...
        <div className="flex flex-col-reverse md:flex-row items-center md:items-start gap-10">
          <div className="w-full md:w-1/3">
            <img
              src={photo}
              alt="profile picture"
              className="w-full h-auto shadow-md border-2 border-solid border-black"
            />
          </div>
          <div className="w-full md:w-2/3">
            ...
            <h2 className="text-5xl mb-6 mt-6 text-center md:text-left">
              I'm{" "}
              <span className="font-bold bg-gradient-to-r from-purple-400 via-pink-500 to-yellow-500 bg-clip-text text-transparent">
                Vigneshwaran Palanivel
              </span>
            </h2>

            <h3 className="text-2xl mb-6 font-bold text-center md:text-left">
            ...
            <div className="mt-10 flex flex-col items-center md:items-start">
              ...
              <div className="w-3/4 md:w-full max-w-xl mx-auto md:mx-0">
                <div className="grid grid-cols-[auto_1fr] gap-6 mt-4 items-start">
                  <p className="min-w-[75px] font-semibold whitespace-nowrap">
                    ADDRESS
                  </p>
                ...
                <div className="grid grid-cols-[auto_1fr] gap-6 mt-4 items-start">
                  ...
                  <div className="leading-snug text-gray-700">
                    <p>
                      <a
                        href="mailto:vigneshwaranp25@gmail.com"
